 ...
 */
final class Version20190830083158 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tutorial ADD category_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD inscription DATETIME NOT NULL');
    }
